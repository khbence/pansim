function T = simout2table(simout,Start_Day,args)
arguments
    simout
    Start_Day = 0
...
[simx,simbeta] = get_SEIRb(simout,args.Population);

simout = num2cell(simout,1);
simx = num2cell(simx,1);

VariableNames = ["S" "E" "I" "R" "TrRate" VariableNames_simout ];

T = timetable(Date,simx{:},simbeta,simout{:},'VariableNames',VariableNames);


function ret = VariableNames_simout 
ret = [
...                                              ┌─ (R_h)
...                                              │     ┌─ (R)
...                                              │     │    ┌─ (D1)
