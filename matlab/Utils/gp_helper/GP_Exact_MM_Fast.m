function [Exp_GP,Var_GP,Cov_xGP] = GP_Exact_MM_Fast(hyp,u,S,args)
arguments
    hyp struct = struct
    u (:,1) = []
    S (:,:) = []
...
tic
[GP_mean] = GP_Exact_MM_Fast(hyp,u,S,"MeanOnly",true);
Time_Fast_Mean = toc;

tic
[GP_mean,GP_var,GP_cov] = GP_Exact_MM_Fast(hyp,u,S);
Time_Fast = toc;
