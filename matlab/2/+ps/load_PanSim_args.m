...
arguments
    Config string {mustBeMember(Config, ...
        ["Free","Real","Delay7","Delay14","Delay21","Omicron"])} = "Free"
end
    ...
    case "Omicron"
        ...
        PanSim_args = [
            ...
            "-k", "0.00041", ...
             ...
             "-a", "inputRealExample/agents1.json", ...
             "-l", "inputRealExample/locations0.json", ...
             "--infectiousnessMultiplier", "3.6,1.81,2.11,2.58,4.32,6.8,6.8", ...
             "--diseaseProgressionScaling", "0.46,1.03,0.813,0.72,0.57,0.463,0.45"];
