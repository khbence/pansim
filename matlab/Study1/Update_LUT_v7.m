function T_ = Update_LUT_v7(T,D,M,dspan)
%%
...
if ~ismember('Beta0',T_.Properties.VariableNames)
    T_ = addvars(T_,T_.Beta,false(height(T_),1),'After','std_Beta','NewVariableNames',["Beta0","Updated"]);
end
...
Dt = join(Dt,M);
Dt.TrRate = Dt.TrRate ./ Dt.Rel_beta_Var;
