...
#define numberOfCategories 9
    ...
    unsigned numberOfVaccinesToday(Timehandler& simTime) {
        ...
        // 8823.13674, 8823.13674, 8756.36833, 8783.88615, 8799.57697, 5717.15701, 5705.37712, 5670.0374, 5662.16849, 5799.61623,
        // 5795.70531, 5772.14553, 3852.02365, 3043.12224, 3031.34235, 934.522142}; float availPerWeek[] = {1115.178518,
        // 486.88636, 895.271552, 1876.9132, 1955.46154, 2471.797635, 4272.165165, 4281.989595, 4580.44486, 4806.19465,
        // 5126.23065, 5138.01055, 4680.550355, 4776.744925, 4988.782925, 4861.15961, 4411.56837, 4411.56837, 4378.184165,
        // 4391.943075, 4399.788485, 4399.788485, 4399.788485, 4399.788485, 4399.788485, 4399.788485, 4399.788485, 4399.788485,
        // 4399.788485, 4399.788485, 4399.788485, 4399.788485}; float availPerWeek[] = {1260.0, 1260.0,1260.0, 1260.0, 1260.0,
        // 1260.0, 1260.0, 1260.0, //8 weeks of 0.1%
...
public:
    ...
    void update(Timehandler& simTime, unsigned timeStep) {
        ...
        thrust::for_each(
            thrust::make_zip_iterator(thrust::make_tuple(sim->agents->PPValues.begin(), sim->agents->agentStats.begin())),
            ...
            [timeStep, timestamp] HD(thrust::tuple<typename Simulation::PPState_t&, AgentStats&> tup) {
                ...
                if (daysSinceImmunization >= 28)
                    thrust::get<0>(tup).setSusceptible(0.04);// 96%
                else if (daysSinceImmunization >= 12)
                    thrust::get<0>(tup).setSusceptible(0.48);// 52%
            });
